...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScannerLog.map'
        db.add_column('euniwspace_scannerlog', 'map',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Map.Map']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScannerLog.map'
        db.delete_column('euniwspace_scannerlog', 'map_id')
    ...
    models = {
        ...
        'euniwspace.viewtime': {
            'Meta': {'object_name': 'ViewTime'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '4'}),
